...
\title{
    ...
    \vspace{0.3cm}
    {\LARGE\bfseries\color{primary} SafeCondo — MVP} \\
    \vspace{0.3cm}
    {\normalsize Decisões técnicas e escopo acordados até o momento}
}
\author{Equipe SafeCondo}
\date{\today}
...
\begin{itemize}[leftmargin=1.5em]
    ...
    usados no SafeCondo: \texttt{Table}, \texttt{Badge}, \texttt{Dialog}, \texttt{Card},
...
Os dados do SafeCondo são \textbf{altamente relacionais} por natureza:
...
\begin{verbatim}
+-------------------------------------------------------------+
|  SafeCondo          [Cond. Parque das Flores]    MANAGER v  |
+-------------------------------------------------------------+
|                                                             |
|  +-----------+  +-----------+  +-----------+  +---------+ |
...
\begin{verbatim}
+-------------------------------------------------------------+
|  SafeCondo          [Cond. Parque das Flores]    RESIDENT v |
+-------------------------------------------------------------+
|                                                             |
|  +-----------------------------------------------------+   |
|  |  Saúde do edifício                                  |   |
...
\begin{itemize}[leftmargin=1.5em]
    ...
    loading, erro e refetch). Suficiente para o SafeCondo, onde todo estado relevante
    vem do servidor.
